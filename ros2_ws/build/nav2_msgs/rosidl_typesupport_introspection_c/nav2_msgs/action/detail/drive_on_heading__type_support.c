...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__DriveOnHeading_Goal__rosidl_typesupport_introspection_c__DriveOnHeading_Goal_message_member_array[4] = {
  {
    "target",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__DriveOnHeading_Goal, disable_collision_checks),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
