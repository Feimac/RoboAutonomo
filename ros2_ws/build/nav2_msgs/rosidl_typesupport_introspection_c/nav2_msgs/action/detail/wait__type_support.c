...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__Wait_Result__rosidl_typesupport_introspection_c__Wait_Result_message_member_array[3] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__Wait_Result, error_msg),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
